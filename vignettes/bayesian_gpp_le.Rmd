...
```{r, fig.width=8, fig.height=4}
params_modl <- list(
  kphio              =  0.0327384,      #calib_output$par[["kphio"]],   
  kphio_par_a        =  -0.0003941861,  #calib_output$par[["kphio_par_a"]],       
  kphio_par_b        =  16.02987,       #calib_output$par[["kphio_par_b"]],
  rd_to_vcmax        =  0.014,  
  soilm_thetastar    =  237.5103,       #calib_output$par[["soilm_thetastar"]], 
  beta_unitcostratio =  186.3469,       #calib_output$par[["beta_unitcostratio"]],
  tau_acclim         =  30,
  kc_jmax            =  0.3843257       #calib_output$par[["kc_jmax"]]
)
...
LE is underestimated compared to previous results, if I increase largely the k_phio to 0.09
LE is correctly simulated
